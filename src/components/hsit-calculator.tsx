...
import { Calculator, Info, TrendingUp, Shield, PiggyBank } from "lucide-react"
...
export default function HSITCalculator() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // Add image to PDF with some margins
      const margin = 10;
      ...
      // Save the PDF
      const fileName = `HSIT-Results-${new Date().toISOString().split('T')[0]}.pdf`;
      pdf.save(fileName);
...
Generated by HSIT Preparedness Calculator
  ...
  if (showResults && results) {
    return (
      <div className="max-w-4xl mx-auto p-4 space-y-6" ref={resultsRef}>
        <Card>
          <CardHeader>
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-blue-800">Monthly Savings Needed</h3>
                  </div>
              ...
              <Card className="bg-green-50 border-green-200">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-green-800">Projected Savings</h3>
                  </div>
    ...
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      <div className="text-center space-y-4 mb-8">
        <h1 className="text-3xl font-bold text-primary">
          Hospitalisation and Surgical Insurance/Takaful (HSIT) Preparedness Calculator
        </h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Help recognize that medical expenses will rise as you age and build awareness of the need to set aside savings early for future healthcare needs
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          {hasHSITPlan && (
            <>
              <Card className="border-none shadow-lg">
                <CardHeader className="bg-primary/5 rounded-t-lg border-b border-primary/10">
                  <CardTitle className="text-primary">Current Coverage Details</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
          ...
          <Button type="submit" className="w-full text-lg py-6 font-semibold shadow-md hover:shadow-xl transition-all" size="lg" disabled={isCalculating}>
            {isCalculating ? "Calculating..." : "Calculate My HSIT Preparedness"}
          </Button>
        </form>
      </Form>
    </div>
